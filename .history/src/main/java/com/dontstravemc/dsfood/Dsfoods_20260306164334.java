...
public class Dsfoods {
    ...
    public static final FoodProperties SMALL_MEAT_FOOD = new FoodProperties.Builder().nutrition(3).saturationModifier(0.3f).meat().build();
    public static final FoodProperties COOKED_SMALL_MEAT_FOOD = new FoodProperties.Builder().nutrition(3).saturationModifier(0.6f).meat().build();
    public static final FoodProperties SMALL_JERKY_FOOD = new FoodProperties.Builder().nutrition(3).saturationModifier(0.6f).meat().build();
}
