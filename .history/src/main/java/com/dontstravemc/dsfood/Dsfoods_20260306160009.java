...
public class Dsfoods {
    ...
    public static final FoodProperties SMALL_MEAT_FOOD =
            new FoodProperties.Builder()
                    .nutrition(2)
                    .saturationModifier(0.2f)
                    .build();

    public static final FoodProperties COOKED_SMALL_MEAT_FOOD =
            new FoodProperties.Builder()
                    .nutrition(3)
                    .saturationModifier(0.4f)
                    .build();

    public static final FoodProperties SMALL_JERKY_FOOD =
            new FoodProperties.Builder()
                    .nutrition(4)
                    .saturationModifier(0.6f)
                    .build();
