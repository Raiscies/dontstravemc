...
public class TechRecipeManager implements SimpleResourceReloadListener<Map<ResourceLocation, TechRecipe>> {
    ...
    private TechRecipe deserialize(ResourceLocation id, JsonObject json) {
        ...
        ItemStack result = new ItemStack(BuiltInRegistries.ITEM.get(ResourceLocation.parse(resultItem)), count);
        ...
        for (String key : ingredientsJson.keySet()) {
            Ingredient ingredient = Ingredient.of(BuiltInRegistries.ITEM.get(ResourceLocation.parse(key)));
