...
public class TechRecipeManager extends SimpleResourceReloader<Map<ResourceLocation, TechRecipe>> implements IdentifiableResourceReloadListener {
    ...
    @Override
    protected Map<ResourceLocation, TechRecipe> prepare(PreparableReloadListener.SharedState store) {
    ...
    @Override
    protected void apply(Map<ResourceLocation, TechRecipe> prepared, PreparableReloadListener.SharedState store) {
