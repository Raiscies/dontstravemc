...
public class ModNetworking {
    public static void registerPackets() {
        ...
        PayloadTypeRegistry.configurationC2S().register(CraftRequestPayload.TYPE, CraftRequestPayload.CODEC);
    ...
    private static void handleCraftRequest(ServerPlayer player, ResourceLocation recipeId) {
        ...
        // Validate tech level (for simplicity, we assume player knowledge is checked later)
        // Check ingredients
