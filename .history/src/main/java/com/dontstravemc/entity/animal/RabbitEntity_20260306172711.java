...
public class RabbitEntity extends PathfinderMob implements GeoEntity, Eater, Tetherable {
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllers) {
        controllers.add(new AnimationController<RabbitEntity>(this, "controller", 5, state -> {
            ...
            if (this.isAlert()) {
                if ((this.tickCount - this.lookPreTick) < 15) { // 15 ticks for look_pre
    ...
    public void aiStep() {
        ...
        if (!this.level().isClientSide()) {
            ...
            // Phase transitions based on duration (e.g. 20 ticks for pre/pst)
    ...
    @Override
    public SoundEvent getEatingSound() { return net.minecraft.sounds.SoundEvents.ENTITY_RABBIT_EAT; }
