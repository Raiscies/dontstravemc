...
public class TrapEntity extends Entity implements GeoEntity {
    ...
    private void captureEntity(LivingEntity entity) {
        ...
        // Use ValueOutput to save entity data
        net.minecraft.world.level.storage.loot.LootDataType.ValueOutputImpl output = 
            new net.minecraft.world.level.storage.loot.LootDataType.ValueOutputImpl(this.capturedEntityData);
