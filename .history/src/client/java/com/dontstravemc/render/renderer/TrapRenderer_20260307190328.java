...
public class TrapRenderer extends GeoEntityRenderer<TrapEntity, TrapRenderState> {
    ...
    @Override
    public void render(TrapEntity entity, Void relatedObject, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, float partialTick) {
        super.render(entity, relatedObject, poseStack, bufferSource, packedLight, partialTick);
