...
public class SanityHudOverlay implements HudRenderCallback {
    ...
    private void drawIcon(GuiGraphics graphics, int x, int y, int u, int v) {
        // Assuming standard 256x256 texture size.
        // arguments: texture, x, y, u, v, width, height, textureWidth, textureHeight
        graphics.blit(SANITY_TEXTURE, x, y, u, v, 9, 9, 256, 256);
    }
