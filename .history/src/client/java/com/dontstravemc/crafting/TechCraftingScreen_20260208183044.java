...
public class TechCraftingScreen extends Screen {
    ...
    private void renderRecipeDetails(GuiGraphics guiGraphics, int dx, int dy, int mouseX, int mouseY) {
        ...
        guiGraphics.drawCenteredString(this.font, selectedRecipe.getResult().getHoverName(), dx + 65, ny + 4, 0xFFFFFFFF);
        ...
        for (int i = 0; i < Math.min(descLines.size(), 4); i++) {
            guiGraphics.drawString(this.font, descLines.get(i), lx + 5, descY + 5 + (i * 10), 0xFFCCCCCC, false);
        }
