...
public class TechCraftingScreen extends Screen {
    ...
    private void renderRecipeDetails(GuiGraphics guiGraphics, int dx, int dy, int mouseX, int mouseY) {
        ...
        // 1. Product Slot
        int px = dx + 66; // Fixed top-left of the display area frame
        int py = dy + 20;
        ...
        // 2. Name Section (Dynamic Width & Centered under product)
        ...
        int ny = dy + 45;
        guiGraphics.fill(contentCenterX - nameBarWidth / 2, ny, contentCenterX + nameBarWidth / 2, ny + 15, 0xB2000000);
        guiGraphics.drawCenteredString(this.font, name, contentCenterX, ny + 4, 0xFFFFFFFF);
        ...
        // 4. Description Section (Dynamic Width & Centered under product)
        int descY = dy + 95;
