...
import com.dontstravemc.block.custom.ForestTurfBlock;
...
import com.dontstravemc.block.custom.BerryBushBlock;
import com.dontstravemc.block.custom.WaxedBerryBushBlock;
import com.dontstravemc.block.custom.RabbitHoleBlock;
...
public class ModBlocks {
    ...
    public static final Block TWIG = registerBlockWithoutItem("twig",
            TwigBlock::new,
            BlockBehaviour.Properties.of()
    ...
    public static final Block EVERGREEN_DOOR = registerBlock("evergreen_door",
    ...
    public static final Block EVERGREEN_TRAPDOOR = registerBlock("evergreen_trapdoor",
    ...
    // Natural berry bush type 1
    public static final Block BERRY_BUSH = registerBlock("berry_bush",
            p -> new BerryBushBlock(p, 1),
            BlockBehaviour.Properties.of()
                    .mapColor(MapColor.PLANT)
                    .noCollision()
                    .strength(0.0f)
    ...
    // Natural berry bush type 2
    public static final Block BERRY_BUSH_2 = registerBlock("berry_bush_2",
            p -> new BerryBushBlock(p, 2),
            BlockBehaviour.Properties.of()
                    .mapColor(MapColor.PLANT)
                    .noCollision()
                    .strength(0.0f)
    ...
    // Transplanted berry bush type 1
    public static final Block BERRY_BUSH_WAXED = registerBlock("berry_bush_waxed",
            p -> new WaxedBerryBushBlock(p, 1),
            BlockBehaviour.Properties.of()
                    .mapColor(MapColor.PLANT)
                    .noCollision()
                    .strength(0.0f)
    ...
    // Transplanted berry bush type 2
    public static final Block BERRY_BUSH_2_WAXED = registerBlock("berry_bush_2_waxed",
            p -> new WaxedBerryBushBlock(p, 2),
            BlockBehaviour.Properties.of()
                    .mapColor(MapColor.PLANT)
                    .noCollision()
                    .strength(0.0f)
    ...
    // Rabbit Hole - Base block for bunny spawning
    public static final Block RABBIT_HOLE = registerBlock("rabbit_hole",
            RabbitHoleBlock::new,
            BlockBehaviour.Properties.of()
    ...
    // Spider Den - Base block for spider spawning`n    public static final Block SPIDER_DEN = registerBlock("spider_den",`n            SpiderDenBlock::new,`n            BlockBehaviour.Properties.of()`n                    .mapColor(MapColor.COLOR_GRAY)`n                    .strength(2.0f)`n                    .sound(SoundType.SLIME_BLOCK)`n                    .noOcclusion()`n    );`n`n    // Evergreen Sapling - grows into spruce-like tree
    public static final Block EVERGREEN_SAPLING = registerBlock("evergreen_sapling",
            com.dontstravemc.block.custom.EvergreenSaplingBlock::new,
            BlockBehaviour.Properties.of()
                    .mapColor(MapColor.PLANT)
                    .noCollision()
                    .randomTicks()
    ...
    public static void registerModBlocks() {
        ...
        StrippableBlockRegistry.register(EVERGREEN_LOG, STRIPPED_EVERGREEN_LOG);
        StrippableBlockRegistry.register(EVERGREEN_WOOD, STRIPPED_EVERGREEN_WOOD);
    }
}