...
public class ModItems {
    ...
    public static final Item COOKED_BERRIES = register("cooked_berries",
            Item::new,
            new Item.Properties().food(Dsfoods.COOKED_BERRIES_FOOD)
    );

    public static final Item MEAT_SMALL = register("meat_small",
            props -> new DsFoodItem(props, 0f, -10.0f, false),
            new Item.Properties().food(Dsfoods.SMALL_MEAT_FOOD)
    );

    public static final Item COOKED_MEAT_SMALL = register("meat_small_cooked",
            props -> new DsFoodItem(props, 0f, 0f, false),
            new Item.Properties().food(Dsfoods.COOKED_SMALL_MEAT_FOOD)
    );

    public static final Item MEAT_SMALL_JERKY = register("meat_small_jerky",
            props -> new DsFoodItem(props, 1.0f, 10.0f, false),
            new Item.Properties().food(Dsfoods.SMALL_JERKY_FOOD)
    );
...
public static final Item BUTTERFLY_SPAWN_EGG = register("butterfly_spawn_egg",
    ...
    public static final Item DS_RABBIT_SPAWN_EGG = register("ds_rabbit_spawn_egg",
            SpawnEggItem::new,
            new Item.Properties()
                    .component(DataComponents.ENTITY_DATA,
                            TypedEntityData.of(ModEntities.RABBIT, createDsRabbitNbt()))
    );

    public static final Item TRAP = register("trap",
            com.dontstravemc.item.custom.TrapItem::new,
            new Item.Properties()
                    .stacksTo(1)
                    .durability(8)
    );

    // Pinecone - drops from evergreen leaves, can be planted
    public static final Item PINECONE = register("pinecone",
            com.dontstravemc.item.custom.PineconeItem::new,
            new Item.Properties()
    );
    ...
    private static CompoundTag createDsRabbitNbt() {
        CompoundTag nbt = new CompoundTag();
        nbt.putString("id", "dontstravemc:rabbit");
        return nbt;
    }
